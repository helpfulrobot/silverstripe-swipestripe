...
class Order extends DataObject
{
  ...
  public function canDelete($member = null)
  {
     ...
     */
    public function addItem(DataObject $product, $quantity = 1, DataObjectSet $productOptions = null)
    {
     ...
     * @return DataObject
     */
    public function findIdenticalItem($product, DataObjectSet $productOptions)
    {
    ...
    //Save new Modifications
      if (isset($data['Modifiers']) && is_array($data['Modifiers'])) {
          foreach ($data['Modifiers'] as $modifierClass => $value) {
