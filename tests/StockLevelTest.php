...
class StockLevelTest extends SWSTest
{
   ...
   */
  public function testStockLevels()
  {
     ...
     */
    public function testAddProductToCartReduceStock()
    {
        $productA = $this->objFromFixture('Product', 'productA');
      ...
      $versions = DB::query('SELECT * FROM "Product_versions" WHERE "RecordID" = ' . $productA->ID);
        ...
        foreach ($versions as $versionRow) {
            $versionsAfterStockChanges[] = $versionRow;
        }
     ...
     */
    public function testRemoveProductFromCartReplaceStock()
    {
        $productA = $this->objFromFixture('Product', 'productA');
        $this->assertEquals(4, $productA->StockLevel()->Level); //Stock starts one down because of orderOneItemOne
     ...
     */
    public function testAddProductVariationToCartReduceStock()
    {
     ...
     */
    public function testRemoveProductVariationFromCartReplaceStock()
    {
        $teeshirtA = $this->objFromFixture('Product', 'teeshirtA');
     ...
     */
    public function testCheckBoundsWhenReducingProductStock()
    {
        $productA = $this->objFromFixture('Product', 'productA');
        $this->assertEquals(4, $productA->StockLevel()->Level); //Stock starts one down because of orderOneItemOne
     ...
     */
    public function testCheckBoundsWhenReducingProductVariationStock()
    {
        $teeshirtA = $this->objFromFixture('Product', 'teeshirtA');
     ...
     */
    public function testProductStockLevelReducedToZero()
    {
        $productA = $this->objFromFixture('Product', 'productA');
        $this->assertEquals(4, $productA->StockLevel()->Level); //Stock starts one down because of orderOneItemOne
     ...
     */
    public function testProductVariationStockLevelReducedToZero()
    {
        $teeshirtA = $this->objFromFixture('Product', 'teeshirtA');
     ...
     */
    public function testProductUnlimitedStockUnaffected()
    {
     ...
     */
    public function testProductVariationUnlimitedStockUnaffected()
    {
        $teeshirtA = $this->objFromFixture('Product', 'teeshirtA');
     ...
     */
    public function testProductOutOfStockNoAddForm()
    {
        $productA = $this->objFromFixture('Product', 'productA');
        $this->assertEquals(4, $productA->StockLevel()->Level); //Stock starts one down because of orderOneItemOne
     ...
     */
    public function testProductWithVariationsOutOfStockNoAddForm()
    {
     ...
     */
    public function testOutOfStockVariationsNotAvailable()
    {
        $product = $this->objFromFixture('Product', 'jeans');
        $this->assertEquals(-1, $product->StockLevel()->Level);
     ...
     */
    public function testRemoveAbandonedCartsWithProductsTask()
    {
     ...
     * then delete it
     */
    public function testRemoveAbandonedCartsWithProductVariationsTask()
    {
        $teeshirtA = $this->objFromFixture('Product', 'teeshirtA');
